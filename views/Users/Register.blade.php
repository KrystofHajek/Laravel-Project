  ...
  <div class="container push-footer-wrapper">
    ...
    <div class="col-sm-8">
      ...
      <div class="col-sm-7">
		...
		<div class="form-group">          
		  {{ Form::checkbox('privacy', 0, array('class' => 'form-control')) }}
		  {{ Form::label('privacylabel', 'I accept the terms and conditions') }} <a href="{{ URL::route('tos') }}" title="Privacy Policy">Privacy Policy</a>    
		  {{ $errors->first('privacy', '<span class="help-block alert alert-danger">:message</span>') }}
		</div>
